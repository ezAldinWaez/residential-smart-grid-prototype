...
.. plot:: _static/plots/C3_csv_data_sample_visualization.py
   :align: center

   Real-time CSV data collection demonstration showing system load, individual house loads, connection states, and utility power exchange during a controlled device operation scenario
