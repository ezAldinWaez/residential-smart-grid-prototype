...
.. mermaid:: ../_static/diagrams/C2_system_arch_simple.mmd
   :align: center
   :caption: RSGP system architecture overview
...
.. only:: html
   ...
   .. container:: diagram-75
      ...
      .. mermaid:: ../_static/diagrams/C2_system_dataflow.mmd
         :align: center
         :caption: RSGP system component interconnection diagram
...
Physical prototyping utilizes standard **breadboards**, **wires**, **LEDs**, **resistors**, and **toggle buttons** to create tangible representations of simulated devices and system states.
...
- **WebPlotDigitizer** extracts data from plots and images, useful for comparing simulation results with published figures.
...
- **Make** automates builds and maintains the consistency of the process across each development environment.
...
-------------------------------------------
The system serves as both a practical solution to a real problem and a research tool that collects data and visualizes it to facilitate research and development of its algorithms. Through its usage of an extensive list of tools and libraries, RSGP aims to utilize the full range of available resources to tackle the problem at hand: that of efficient distribution of generated solar power.
