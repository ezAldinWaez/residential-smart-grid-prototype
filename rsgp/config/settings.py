...
class Settings:
    ...
    # Kept at 0.95, a reasonable general value
    EFFECTIVE_INVERTER_NOMINAL_EFFICIENCY = 0.95

    # ==============================================================================
    # LOGGING SETTINGS
    # ==============================================================================
    # It could be "DEBUG", "INFO", "WARNING", "ERROR", or "CRITICAL".
    LOG_LEVEL = "DEBUG"
    ...
    _CSV_Log_DIR = _Log_DIR / \
        f"rsgp_{datetime.now().strftime('%Y-%m-%d_%H-%M')}"
