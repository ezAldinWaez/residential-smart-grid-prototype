...
.. note:: Houses Loads Simulation also optionally logs the system load over time into a csv file. Whether it logs or not is set in the project settings along the number of houses in the simulation.
