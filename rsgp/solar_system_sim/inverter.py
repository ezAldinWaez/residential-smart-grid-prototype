...
class Inverter:
    ...
    Pdco: float                #: DC power rating of the inverter (W). This is pdc0 for pvwatts.
    ...
    is_grid_connected: bool    #: Flag indicating if the inverter is connected to the utility grid.
